...
<head>
    ...
    <link rel="stylesheet" href="/plugins/adminLTE/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
    <!-- Bootstrap time Picker -->
    <link rel="stylesheet" href="/plugins/adminLTE/plugins/timepicker/bootstrap-timepicker.min.css">
    <!-- Select2 -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="/plugins/adminLTE/index2.html" class="logo">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/plugins/adminLTE/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/plugins/adminLTE/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/plugins/adminLTE/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                        <li><a href="/plugins/adminLTE/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
...
<!-- InputMask -->
<script src="/plugins/adminLTE/plugins/input-mask/jquery.inputmask.js"></script>
<script src="/plugins/adminLTE/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
<script src="/plugins/adminLTE/plugins/input-mask/jquery.inputmask.extensions.js"></script>
<!-- date-range-picker -->
...
<!-- bootstrap color picker -->
<script src="/plugins/adminLTE/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
