                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc">作者</th>
                                <th class="sorting">评论内容</th>
                                <th class="sorting">回复至</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="comment">
                                <tr>
                                    ...
                                    <td>
                                        <img src="/images/user2-160x160.jpg" style="height: 70px;width: 70px;">
                                    </td>
                                    <td>
                                        ${comment.commentContent}
                                    </td>
                                    <td>
                                        ${comment.commentPname}
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="/comment/edit/${comment.commentId}"'>编辑</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="/comment/delete/${comment.commentId}"'>删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
